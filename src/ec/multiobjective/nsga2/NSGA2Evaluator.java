...
public class NSGA2Evaluator extends SimpleEvaluator
    ...
    public void assignSparsity(Individual[] front)
        ...
        for (int i = 0; i < numObjectives; i++)
            ...
            double minObjValue = ((NSGA2MultiObjectiveFitness) front[0].fitness).getObjective(o);
            double maxObjValue = ((NSGA2MultiObjectiveFitness) front[front.length - 1].fitness).getObjective(o);
