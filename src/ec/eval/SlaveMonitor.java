 ...
 *
 ...
 (waitForAllSlavesToFinishEvaluating(...)), demo if any individual in a job has been finished
    ...
    public void waitForAllSlavesToFinishEvaluating( final EvolutionState state )
        ...
        synchronized(allSlaves)
            ...
            while( iter.hasNext() )
                ...
                try { slaveConnection.dataOut.flush(); } catch (IOException e) {} // we'll catch this error later....
                }
            notifyMonitor(allSlaves);
            }
