...
public class GrammarParser implements Prototype
    ...
    /** 
     * The predictive parse table to parse the io tree,
    ...
    /**
     * We do not have any example dagp to demo with FOLLOW-SETs,
     * so the FOLLOW-SET is empty, we need to demo with a dagp
